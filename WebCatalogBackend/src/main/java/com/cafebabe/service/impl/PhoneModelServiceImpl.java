...
import com.cafebabe.repository.PhoneModelRepository;
...
@Service
public class PhoneModelServiceImpl extends BaseDataObjectWithUniqueNameServiceImpl<PhoneModelRepository, PhoneModel>
    ...
    public <T> void buildCriteriaQuery(From<?, PhoneModel> root, PhoneModelFilterDto filterDto, CriteriaBuilder criteriaBuilder, CriteriaQuery<T> criteriaQuery) {
        ...
        leftJoinAndFilter(root, filterDto.getDustAndMoistureProtections(), predicates, PhoneModel_.DUST_AND_MOISTURE_PROTECTION, DustAndMoistureProtection_.ID, criteriaBuilder);
        ...
        leftJoinAndFilter(root, filterDto.getScreenProtections(), predicates, PhoneModel_.SCREEN_PROTECTION, ScreenProtection_.ID, criteriaBuilder);
    ...
    protected <T extends BaseDataObjectWithUniqueName> void joinAndFilter(From<?, ?> root, List<T> entities, List<Predicate> predicates, String joinEntityPath, String joinEntityIdPath, CriteriaBuilder criteriaBuilder) {
    ...
    protected <T extends BaseDataObjectWithUniqueName> void leftJoinAndFilter(From<?, ?> root, List<T> entities, List<Predicate> predicates, String joinEntityPath, String joinEntityIdPath, CriteriaBuilder criteriaBuilder) {
